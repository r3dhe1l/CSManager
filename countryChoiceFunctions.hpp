...
namespace r3d
{
	...
	static inline const std::map <std::string, std::string> countryToCulture{
		...
		{availableCountries.at(5), availableCultures.at(8)},
		...
		{availableCountries.at(10), availableCultures.at(15)},
		...
		{availableCountries.at(25), availableCultures.at(8)},//Hungary - czech
